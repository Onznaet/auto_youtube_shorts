...
Этот проект представляет собой автоматизированный конвейер для создания и загрузки видео. Он использует подключение ваших источников и ИИ для генерации сценариев, поиска релевантных изображений/видеофрагментов, синтеза речи, сборки финального видео и автоматической загрузки на YouTube и телеграм.
